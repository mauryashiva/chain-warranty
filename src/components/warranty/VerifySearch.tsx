...
import { useVerifyWarranty } from "@/hooks/use-verify-warranty";
import {
  Search,
  ShieldCheck,
  ShieldAlert,
    ...
    <div className="max-w-3xl space-y-8">
      ...
      <form onSubmit={handleSearch} className="relative group">
        ...
        <input
          ...
          className="w-full rounded-[2rem] border-4 border-gray-100 bg-white py-6 pl-16 pr-32 text-lg font-black text-slate-950 outline-none transition-all focus:border-blue-600 dark:border-neutral-900 dark:bg-black dark:text-white shadow-2xl shadow-slate-200/50 dark:shadow-none"
        />
        <button
          type="submit"
