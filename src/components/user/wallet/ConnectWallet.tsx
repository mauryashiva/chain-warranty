...
export default function ConnectWallet() {
  ...
  const handleLogin = async () => {
    try {
      ...
      // 3. Get Nonce from Backend using standardized apiFetch
      ...
      // 6. Verify with Backend using standardized apiFetch
      // apiFetch automatically throws an error if the response is not OK
